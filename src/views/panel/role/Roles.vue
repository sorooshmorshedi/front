                        ...
                        <template v-slot:activator="{ on, attrs }">
                          <v-hover v-slot="{ hover }">
                            <v-btn
                                ...
                                :disabled="!isEditing"
                            >
                              <v-icon :style="{ 'color': hover ? '#F1416C' : '#697480' }">fa-times</v-icon>
                            </v-btn>
                          </v-hover>
                        </template>
                        غیر فعال کردن همه
                        ...
                        <template v-slot:activator="{ on, attrs }">
                          <v-hover v-slot="{ hover }">
                            ...
                            <v-btn
                                ...
                                :disabled="!isEditing"
                            >
                              <v-icon :style="{ 'color': hover ? '#50CD89' : '#697480' }">fa-check-double</v-icon>
                            </v-btn>
                          </v-hover>
                        </template>
                        فعال کردن همه
                        ...
                        <template v-slot:activator="{ on, attrs }">
                          <v-hover v-slot="{ hover }">
                            ...
                            <v-btn
                                ...
                                v-on="on"
                            >
                              <v-icon :style="{ 'color': hover ? '#FFC700' : '#697480' }">fa-user-shield</v-icon>
                            </v-btn>
                          </v-hover>
                        </template>
                        همه مواردی که خود کاربر ثبت کرده است
                      </v-tooltip>
