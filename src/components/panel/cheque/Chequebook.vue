      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="form-group col-12 col-md-3">
                  ...
                  <input v-if="chequebook.id" type="text" class="form-control" disabled v-model="chequebook.code">
                  <input v-else type="text" class="form-control" disabled :value="chequebookCode">
                </div>
                <div class="form-group col-12 col-md-9">
                  <label for="">حساب بانک</label>
                  <multiselect dir="rtl" label="name" track-by="id" :options="accountsSelectValues.banks" v-model="chequebook.account" />
                </div>

                <div class="form-group col-12 col-md-9 offset-md-3" v-if="chequebook.account && chequebook.account.floatAccountGroup">
                  <label for="">حساب شناور</label>
                  <multiselect dir="rtl" label="name" track-by="id" :options="chequebook.account.floatAccountGroup.floatAccounts" v-model="chequebook.floatAccount" />
                </div>
          ...
          <div class="modal-footer">
            ...
            <button v-if="chequebook.id" @click="updateChequebook()" type="button" class="btn btn-primary">ثبت</button>
