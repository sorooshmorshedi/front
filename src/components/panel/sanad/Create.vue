                ...
                <table class="table table-striped ">
                  ...
                  <tbody>
                    <tr v-for="(row,i) in rows" :key="i">
                      <td>{{ i+1 }}</td>
                      <td>
                        <multiselect :options="accountsSelectValues.levels[3]" v-model="rows[i].account" track-by="pk" label="title" />
                      </td>
                      <td>
                      ...
                      <td>
                        <multiselect :options="floatAccounts(rows[i])" v-model="rows[i].floatAccount" track-by="pk" label="name" />
                      </td>
                      <td>
                        <multiselect :options="costCenters(rows[i])" v-model="rows[i].costCenter" track-by="pk" label="name" />
                      </td>
                      <td>
