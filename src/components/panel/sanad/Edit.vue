        ...
        <div class="card-body">
          ...
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <a class="nav-item nav-link active" id="nav-0-tab" data-toggle="tab" href="#nav-nature" role="tab">ماهیت</a>
              <a class="nav-item nav-link" id="nav-1-tab" data-toggle="tab" href="#nav-group" role="tab">گروه</a>
              <a class="nav-item nav-link" id="nav-2-tab" data-toggle="tab" href="#nav-category" role="tab">دسته بندی</a>
              <a class="nav-item nav-link" id="nav-3-tab" data-toggle="tab" href="#nav-ware" role="tab">کالا</a>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-nature" role="tabpanel">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="">کد</label>
                  <multiselect :options="waresSelectValues.levels[0]" v-model="wareLevel" track-by="pk" label="title" />
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="nav-group" role="tabpanel">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="">کد</label>
                  <multiselect :options="waresSelectValues.levels[1]" v-model="wareLevel" track-by="pk" label="title" />
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="nav-category" role="tabpanel">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="">کد</label>
                  <multiselect :options="waresSelectValues.levels[2]" v-model="wareLevel" track-by="pk" label="title" />
                </div>
              </div>
            ...
            <div class="tab-pane fade " id="nav-ware" role="tabpanel">
              <div class="row">
                <div class="form-group col-md-4">
                  <label for="">کد</label>
                  <multiselect :options="waresSelectValues.wares" v-model="ware" track-by="pk" label="title" />
                </div>
              </div>
