    ...
    <div class="col-12">
      <div class="card right ">
        <div class="card-body">
          ...
          <datatable v-if="showTable" :cols="options.cols" :url="options.url" :default-filters="{type}" :router-name="options.routerName" :router-default-params="options.defaultParams" ref="datatable" />
        </div>
      </div>
    </div>
  </div>
